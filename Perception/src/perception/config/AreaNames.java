...
public class AreaNames {
    ...
    public static final int CandidatesPrioritizer_fQ1 = IDHelper.generateID("ITp", 21, 0);
    public static final int CandidatesPrioritizer_fQ2 = IDHelper.generateID("ITp", 22, 0);
    public static final int CandidatesPrioritizer_fQ3 = IDHelper.generateID("ITp", 23, 0);
    public static final int CandidatesPrioritizer_fQ4 = IDHelper.generateID("ITp", 24, 0);
    public static final int CandidatesPrioritizer_pQ1 = IDHelper.generateID("ITp", 25, 0);
    public static final int CandidatesPrioritizer_pQ2 = IDHelper.generateID("ITp", 26, 0);
    public static final int CandidatesPrioritizer_pQ3 = IDHelper.generateID("ITp", 27, 0);
    public static final int CandidatesPrioritizer_pQ4 = IDHelper.generateID("ITp", 28, 0);
    public static final int CandidatesBuffer_fQ1 = IDHelper.generateID("ITp", 29, 0);
    public static final int CandidatesBuffer_fQ2 = IDHelper.generateID("ITp", 30, 0);
    public static final int CandidatesBuffer_fQ3 = IDHelper.generateID("ITp", 31, 0);
    public static final int CandidatesBuffer_fQ4 = IDHelper.generateID("ITp", 32, 0);
    public static final int CandidatesBuffer_pQ1 = IDHelper.generateID("ITp", 33, 0);
