 ...
 * @author axeladn
 */
public class Mem_fQ4 extends Activity {
    
    private static final String userID = "Mem_fQ4";
    
    public Mem_fQ4() {
        this.ID = AreaNames.Mem_fQ4;
    ...
    public void receive(int nodeID, byte[] data) {
        try {
            ...
            Logger.getLogger(Mem_fQ4.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
