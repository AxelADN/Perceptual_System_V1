 ...
 * @author axeladn
 */
public class Mem_pQ4 extends Activity {
    
    private static final String userID = "Mem_pQ4";
    
    public Mem_pQ4() {
        this.ID = AreaNames.Mem_pQ4;
    ...
    public void receive(int nodeID, byte[] data) {
        try {
            ...
            Logger.getLogger(Mem_pQ4.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
