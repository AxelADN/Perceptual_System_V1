 ...
 * @author axeladn
 */
public class Mem_fQ1 extends Activity {
    
    private static final String userID = "Mem_fQ1";
    
    public Mem_fQ1() {
        this.ID = AreaNames.Mem_fQ1;
    ...
    public void receive(int nodeID, byte[] data) {
        try {
            ...
            Logger.getLogger(Mem_fQ1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
