 ...
 * @author axeladn
 */
public class Mem_pQ2 extends Activity {
    
    private static final String userID = "Mem_pQ2";
    
    public Mem_pQ2() {
        this.ID = AreaNames.Mem_pQ2;
    ...
    public void receive(int nodeID, byte[] data) {
        try {
            ...
            Logger.getLogger(Mem_pQ2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
