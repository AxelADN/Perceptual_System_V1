 ...
 * @author axeladn
 */
public class Mem_pQ3 extends Activity {
    
    private static final String userID = "Mem_pQ3";
    
    public Mem_pQ3() {
        this.ID = AreaNames.Mem_pQ3;
    ...
    public void receive(int nodeID, byte[] data) {
        try {
            ...
            Logger.getLogger(Mem_pQ3.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
