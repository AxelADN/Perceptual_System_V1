 ...
 * @author axeladn
 */
public class Mem_fQ2 extends Activity {
    
    private static final String userID = "Mem_fQ2";
    
    public Mem_fQ2() {
        this.ID = AreaNames.Mem_fQ2;
    ...
    public void receive(int nodeID, byte[] data) {
        try {
            ...
            Logger.getLogger(Mem_fQ2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
