...
/**
 * Class Template for CandidatesPrioritizer class group. The inherited subclasses
 * receive data from RIIC classes and HolisticClassifier class. It verifies the origin
 * of the incoming data and then send it to CandidatesBuffer class group.
 * <p>
 * When the origin of the data is HolisticClassifier class, it sends this data to the
 * CandidatesBuffer group class. Then awaits for data incoming from the RIIC
 * group class to continue receiving data from the HolisticClassifier class. Any other
...
public class CandidatesPrioritizerTemplate extends ActivityTemplate {
     ...
     *
     * @see perception.structures.RIIC_hAndPreObjectSegmentPair RIIC_hAndPreObjectSegmentPair structure
     */
