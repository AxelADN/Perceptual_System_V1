 ...
 * @author axeladn
 */
public class Id_fQ4 extends Activity {
    
    private LongSpike spike;
    private static final String userID = "Id_fQ4";
    
    public Id_fQ4() {        
        this.ID = AreaNames.Id_fQ4;
    ...
    public void receive(int nodeID, byte[] data) {
        try {
            ...
            Logger.getLogger(Id_fQ4.class.getName()).log(Level.SEVERE, null, ex);
        }
