 ...
 * @author axeladn
 */
public class Id_pQ3 extends Activity {
    
    private LongSpike spike;
    private static final String userID = "Id_pQ3";
    
    public Id_pQ3() {        
        this.ID = AreaNames.Id_pQ3;
    ...
    public void receive(int nodeID, byte[] data) {
        try {
            ...
            Logger.getLogger(Id_pQ3.class.getName()).log(Level.SEVERE, null, ex);
        }
