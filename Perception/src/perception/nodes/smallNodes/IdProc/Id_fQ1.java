 ...
 * @author axeladn
 */
public class Id_fQ1 extends Activity {
    
    private LongSpike spike;
    private static final String userID = "Id_fQ1";
    
    public Id_fQ1() {        
        this.ID = AreaNames.Id_fQ1;
    ...
    public void receive(int nodeID, byte[] data) {
        try {
            ...
            Logger.getLogger(Id_fQ1.class.getName()).log(Level.SEVERE, null, ex);
        }
