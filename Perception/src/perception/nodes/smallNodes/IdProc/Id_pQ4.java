 ...
 * @author axeladn
 */
public class Id_pQ4 extends Activity {
    
    private LongSpike spike;
    private static final String userID = "Id_pQ4";
    
    public Id_pQ4() {        
        this.ID = AreaNames.Id_pQ4;
    ...
    public void receive(int nodeID, byte[] data) {
        try {
            ...
            Logger.getLogger(Id_pQ4.class.getName()).log(Level.SEVERE, null, ex);
        }
