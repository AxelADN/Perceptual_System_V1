 ...
 * @author axeladn
 */
public class Id_fQ2 extends Activity {
    
    private LongSpike spike;
    private static final String userID = "Id_fQ2";
    
    public Id_fQ2() {        
        this.ID = AreaNames.Id_fQ2;
    ...
    public void receive(int nodeID, byte[] data) {
        try {
            ...
            Logger.getLogger(Id_fQ2.class.getName()).log(Level.SEVERE, null, ex);
        }
