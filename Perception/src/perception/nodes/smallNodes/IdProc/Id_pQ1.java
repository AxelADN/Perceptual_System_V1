 ...
 * @author axeladn
 */
public class Id_pQ1 extends Activity {
    
    private LongSpike spike;
    private static final String userID = "Id_pQ1";
    
    public Id_pQ1() {        
        this.ID = AreaNames.Id_pQ1;
    ...
    public void receive(int nodeID, byte[] data) {
        try {
            ...
            Logger.getLogger(Id_pQ1.class.getName()).log(Level.SEVERE, null, ex);
        }
