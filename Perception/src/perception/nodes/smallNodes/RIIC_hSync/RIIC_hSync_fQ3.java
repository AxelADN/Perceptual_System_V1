...
/**
 * RIIC_hSync for route <code>fQ3</code>.
 *
 * @author axeladn
 * @version 1.0
 *
 ...
 */
public class RIIC_hSync_fQ3 extends RIIC_hSyncTemplate {
     ...
     */
    public RIIC_hSync_fQ3() {
        this.ID = AreaNames.RIIC_hSync_fQ3;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "RIIC_H_SYNC_FQ3: init()");
    }
