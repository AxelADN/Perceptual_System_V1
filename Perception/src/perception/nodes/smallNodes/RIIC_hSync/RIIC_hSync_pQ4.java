...
/**
 * RIIC_hSync for route <code>pQ4</code>.
 *
 * @author axeladn
 * @version 1.0
 *
 ...
 */
public class RIIC_hSync_pQ4 extends RIIC_hSyncTemplate {
     ...
     */
    public RIIC_hSync_pQ4() {
        this.ID = AreaNames.RIIC_hSync_pQ4;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "RIIC_H_SYNC_PQ4: init()");
    }
