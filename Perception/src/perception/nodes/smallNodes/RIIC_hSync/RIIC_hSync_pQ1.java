...
/**
 * RIIC_hSync for route <code>pQ1</code>.
 *
 * @author axeladn
 * @version 1.0
 *
 ...
 */
public class RIIC_hSync_pQ1 extends RIIC_hSyncTemplate {
     ...
     */
    public RIIC_hSync_pQ1() {
        this.ID = AreaNames.RIIC_hSync_pQ1;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "RIIC_H_SYNC_PQ1: init()");
    }
