...
/**
 * RIIC_hSync for route <code>pQ3</code>.
 *
 * @author axeladn
 * @version 1.0
 *
 ...
 */
public class RIIC_hSync_pQ3 extends RIIC_hSyncTemplate {
     ...
     */
    public RIIC_hSync_pQ3() {
        this.ID = AreaNames.RIIC_hSync_pQ3;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "RIIC_H_SYNC_PQ3: init()");
    }
