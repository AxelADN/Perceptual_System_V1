...
/**
 * RIIC_hSync for route <code>pQ2</code>.
 *
 * @author axeladn
 * @version 1.0
 *
 ...
 */
public class RIIC_hSync_pQ2 extends RIIC_hSyncTemplate {
     ...
     */
    public RIIC_hSync_pQ2() {
        this.ID = AreaNames.RIIC_hSync_pQ2;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "RIIC_H_SYNC_PQ2: init()");
    }
