...
/**
 * RIIC_hSync for route <code>fQ4</code>.
 *
 * @author axeladn
 * @version 1.0
 *
 ...
 */
public class RIIC_hSync_fQ4 extends RIIC_hSyncTemplate {
     ...
     */
    public RIIC_hSync_fQ4() {
        this.ID = AreaNames.RIIC_hSync_fQ4;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "RIIC_H_SYNC_FQ4: init()");
    }
