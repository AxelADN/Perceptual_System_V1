...
/**
 * CanidatesPrioritizer for route <code>fQ3</code>.
 * 
 * @author axeladn
 * @version 1.0
 */
public class CandidatesPrioritizer_fQ3 extends CandidatesPrioritizerTemplate {
     ...
     */
    public CandidatesPrioritizer_fQ3() {
        this.ID = AreaNames.CandidatesPrioritizer_fQ3;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "CANDIDATES_PRIORITIZER_FQ3: init()");
    }
