...
/**
 * CanidatesPrioritizer for route <code>fQ2</code>.
 * 
 * @author axeladn
 * @version 1.0
 */
public class CandidatesPrioritizer_fQ2 extends CandidatesPrioritizerTemplate {
     ...
     */
    public CandidatesPrioritizer_fQ2() {
        this.ID = AreaNames.CandidatesPrioritizer_fQ2;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "CANDIDATES_PRIORITIZER_FQ2: init()");
    }
