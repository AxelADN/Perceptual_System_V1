...
/**
 * CanidatesPrioritizer for route <code>fQ4</code>.
 * 
 * @author axeladn
 * @version 1.0
 */
public class CandidatesPrioritizer_fQ4 extends CandidatesPrioritizerTemplate {
     ...
     */
    public CandidatesPrioritizer_fQ4() {
        this.ID = AreaNames.CandidatesPrioritizer_fQ4;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "CANDIDATES_PRIORITIZER_FQ4: init()");
    }
