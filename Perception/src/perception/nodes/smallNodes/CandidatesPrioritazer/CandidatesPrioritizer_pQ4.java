...
/**
 * CanidatesPrioritizer for route <code>pQ4</code>.
 * 
 * @author axeladn
 * @version 1.0
 */
public class CandidatesPrioritizer_pQ4 extends CandidatesPrioritizerTemplate {
     ...
     */
    public CandidatesPrioritizer_pQ4() {
        this.ID = AreaNames.CandidatesPrioritizer_pQ4;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "CANDIDATES_PRIORITIZER_PQ4: init()");
    }
