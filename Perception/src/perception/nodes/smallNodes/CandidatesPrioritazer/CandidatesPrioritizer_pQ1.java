...
/**
 * CanidatesPrioritizer for route <code>pQ1</code>.
 * 
 * @author axeladn
 * @version 1.0
 */
public class CandidatesPrioritizer_pQ1 extends CandidatesPrioritizerTemplate {
     ...
     */
    public CandidatesPrioritizer_pQ1() {
        this.ID = AreaNames.CandidatesPrioritizer_pQ1;
        this.LOCAL_RETINOTOPIC_ID = ActivityTemplate.RETINOTOPIC_ID.get(4);
    }
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "CANDIDATES_PRIORITIZER_PQ1: init()");
    }
