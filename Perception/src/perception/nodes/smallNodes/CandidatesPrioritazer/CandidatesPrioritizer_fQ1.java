...
/**
 * CanidatesPrioritizer for route <code>fQ1</code>.
 * 
 * @author axeladn
 * @version 1.0
 */
public class CandidatesPrioritizer_fQ1 extends CandidatesPrioritizerTemplate {
     ...
     */
    public CandidatesPrioritizer_fQ1() {
        this.ID = AreaNames.CandidatesPrioritizer_fQ1;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "CANDIDATES_PRIORITIZER_FQ1: init()");
    }
