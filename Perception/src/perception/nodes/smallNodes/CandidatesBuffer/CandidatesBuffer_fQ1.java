...
/**
 * CandidatesBuffer for route <code>fQ1</code>.
 *
 * @author axeladn
 * @version 1.0
 *
 ...
 * Template
 */
public class CandidatesBuffer_fQ1 extends CandidatesBufferTemplate {
     ...
     */
    public CandidatesBuffer_fQ1() {
        this.ID = AreaNames.CandidatesBuffer_fQ1;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "CANDIDATES_BUFFER_FQ1: init()");
    }
