...
/**
 * CandidatesBuffer for route <code>fQ3</code>.
 *
 * @author axeladn
 * @version 1.0
 *
 ...
 * Template
 */
public class CandidatesBuffer_fQ3 extends CandidatesBufferTemplate {
     ...
     */
    public CandidatesBuffer_fQ3() {
        this.ID = AreaNames.CandidatesBuffer_fQ3;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "CANDIDATES_BUFFER_FQ3: init()");
    }
