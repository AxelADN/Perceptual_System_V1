...
/**
 * CandidatesBuffer for route <code>pQ2</code>.
 *
 * @author axeladn
 * @version 1.0
 *
 ...
 * Template
 */
public class CandidatesBuffer_pQ2 extends CandidatesBufferTemplate {
     ...
     */
    public CandidatesBuffer_pQ2() {
        this.ID = AreaNames.CandidatesBuffer_pQ2;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "CANDIDATES_BUFFER_PQ2: init()");
    }
