...
/**
 * CandidatesBuffer for route <code>pQ1</code>.
 *
 * @author axeladn
 * @version 1.0
 *
 ...
 * Template
 */
public class CandidatesBuffer_pQ1 extends CandidatesBufferTemplate {
     ...
     */
    public CandidatesBuffer_pQ1() {
        this.ID = AreaNames.CandidatesBuffer_pQ1;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "CANDIDATES_BUFFER_PQ1: init()");
    }
