...
/**
 * CandidatesBuffer for route <code>pQ4</code>.
 *
 * @author axeladn
 * @version 1.0
 *
 ...
 * Template
 */
public class CandidatesBuffer_pQ4 extends CandidatesBufferTemplate {
     ...
     */
    public CandidatesBuffer_pQ4() {
        this.ID = AreaNames.CandidatesBuffer_pQ4;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "CANDIDATES_BUFFER_PQ4: init()");
    }
