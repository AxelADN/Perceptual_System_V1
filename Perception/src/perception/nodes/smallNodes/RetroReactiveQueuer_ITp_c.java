 ...
 * class group
 */
public class RetroReactiveQueuer_ITp_c extends ActivityTemplate {
     ...
     * from this node.
     */
    public RetroReactiveQueuer_ITp_c() {
        this.ID = AreaNames.RetroReactiveQueuer_ITp_c;
    }
    ...
    @Override
    public void init() {
        SimpleLogger.log(this, "cRETRO_REACTIVE_QUEUER: init()");
    }
    ...
    public void receive(int nodeID, byte[] data) {
        try {
            ...
            Logger.getLogger(RetroReactiveQueuer_ITp_c.class.getName()
