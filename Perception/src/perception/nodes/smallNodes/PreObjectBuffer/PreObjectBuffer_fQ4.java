...
/**
 * PreObjectBuffer for route <code>fQ4</code>.
 *
 * @author axeladn
 * @version 1.0
 *
 ...
 * Template
 */
public class PreObjectBuffer_fQ4 extends PreObjectBufferTemplate {
     ...
     */
    public PreObjectBuffer_fQ4() {
        this.ID = AreaNames.PreObjectBuffer_fQ4;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "PREOBJECT_BUFFER_FQ4: init()");
    }
