...
/**
 * PreObjectBuffer for route <code>fQ3</code>.
 *
 * @author axeladn
 * @version 1.0
 *
 ...
 * Template
 */
public class PreObjectBuffer_fQ3 extends PreObjectBufferTemplate {
     ...
     */
    public PreObjectBuffer_fQ3() {
        this.ID = AreaNames.PreObjectBuffer_fQ3;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "PREOBJECT_BUFFER_FQ3: init()");
    }
