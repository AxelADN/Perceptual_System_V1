...
/**
 * PreObjectBuffer for route <code>pQ4</code>.
 *
 * @author axeladn
 * @version 1.0
 *
 ...
 * Template
 */
public class PreObjectBuffer_pQ4 extends PreObjectBufferTemplate {
     ...
     */
    public PreObjectBuffer_pQ4() {
        this.ID = AreaNames.PreObjectBuffer_pQ4;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "PREOBJECT_BUFFER_PQ4: init()");
    }
