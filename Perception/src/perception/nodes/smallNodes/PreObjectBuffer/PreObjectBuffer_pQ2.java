...
/**
 * PreObjectBuffer for route <code>pQ2</code>.
 *
 * @author axeladn
 * @version 1.0
 *
 ...
 * Template
 */
public class PreObjectBuffer_pQ2 extends PreObjectBufferTemplate {
     ...
     */
    public PreObjectBuffer_pQ2() {
        this.ID = AreaNames.PreObjectBuffer_pQ2;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "PREOBJECT_BUFFER_PQ2: init()");
    }
