...
/**
 * RIIC_cSync for route <code>fQ1</code>.
 *
 * @author axeladn
 * @version 1.0
 *
 ...
 */
public class RIIC_cSync_fQ1 extends RIIC_cSyncTemplate {
     ...
     */
    public RIIC_cSync_fQ1() {
        this.ID = AreaNames.RIIC_cSync_fQ1;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "RIIC_C_SYNC_FQ1: init()");
    }
