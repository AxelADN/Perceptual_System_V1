...
/**
 * RIIC_cSync for route <code>pQ4</code>.
 *
 * @author axeladn
 * @version 1.0
 *
 ...
 */
public class RIIC_cSync_pQ4 extends RIIC_cSyncTemplate {
     ...
     */
    public RIIC_cSync_pQ4() {
        this.ID = AreaNames.RIIC_cSync_pQ4;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "RIIC_C_SYNC_PQ4: init()");
    }
