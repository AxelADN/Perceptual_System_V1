...
/**
 * RIIC_cSync for route <code>fQ2</code>.
 *
 * @author axeladn
 * @version 1.0
 *
 ...
 */
public class RIIC_cSync_fQ2 extends RIIC_cSyncTemplate {
     ...
     */
    public RIIC_cSync_fQ2() {
        this.ID = AreaNames.RIIC_cSync_fQ2;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "RIIC_C_SYNC_FQ2: init()");
    }
