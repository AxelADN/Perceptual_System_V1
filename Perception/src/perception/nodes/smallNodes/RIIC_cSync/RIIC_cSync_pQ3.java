...
/**
 * RIIC_cSync for route <code>pQ3</code>.
 *
 * @author axeladn
 * @version 1.0
 *
 ...
 */
public class RIIC_cSync_pQ3 extends RIIC_cSyncTemplate {
     ...
     */
    public RIIC_cSync_pQ3() {
        this.ID = AreaNames.RIIC_cSync_pQ3;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "RIIC_C_SYNC_PQ3: init()");
    }
