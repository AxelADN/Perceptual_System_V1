...
/**
 * PreObjectPrioritizer for route <code>fQ4</code>.
 * 
 * @author axeladn
 * @version 1.0
 */
public class PreObjectPrioritizer_fQ4 extends PreObjectPrioritizerTemplate {
     ...
     */
    public PreObjectPrioritizer_fQ4() {
        this.ID = AreaNames.PreObjectPrioritizer_fQ4;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "PREOBJECT_PRIORITIZER_FQ4: init()");
    }
