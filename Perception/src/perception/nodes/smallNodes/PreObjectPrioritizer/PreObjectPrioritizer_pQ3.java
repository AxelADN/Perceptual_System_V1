...
/**
 * PreObjectPrioritizer for route <code>pQ3</code>.
 * 
 * @author axeladn
 * @version 1.0
 */
public class PreObjectPrioritizer_pQ3 extends PreObjectPrioritizerTemplate {
     ...
     */
    public PreObjectPrioritizer_pQ3() {
        this.ID = AreaNames.PreObjectPrioritizer_pQ3;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "PREOBJECT_PRIORITIZER_PQ3: init()");
    }
