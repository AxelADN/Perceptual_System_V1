...
/**
 * PreObjectPrioritizer for route <code>pQ4</code>.
 * 
 * @author axeladn
 * @version 1.0
 */
public class PreObjectPrioritizer_pQ4 extends PreObjectPrioritizerTemplate {
     ...
     */
    public PreObjectPrioritizer_pQ4() {
        this.ID = AreaNames.PreObjectPrioritizer_pQ4;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "PREOBJECT_PRIORITIZER_PQ4: init()");
    }
