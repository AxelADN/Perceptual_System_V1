...
/**
 * PreObjectPrioritizer for route <code>fQ3</code>.
 * 
 * @author axeladn
 * @version 1.0
 */
public class PreObjectPrioritizer_fQ3 extends PreObjectPrioritizerTemplate {
     ...
     */
    public PreObjectPrioritizer_fQ3() {
        this.ID = AreaNames.PreObjectPrioritizer_fQ3;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "PREOBJECT_PRIORITIZER_FQ3: init()");
    }
