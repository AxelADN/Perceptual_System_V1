...
/**
 * PreObjectPrioritizer for route <code>fQ2</code>.
 * 
 * @author axeladn
 * @version 1.0
 */
public class PreObjectPrioritizer_fQ2 extends PreObjectPrioritizerTemplate {
     ...
     */
    public PreObjectPrioritizer_fQ2() {
        this.ID = AreaNames.PreObjectPrioritizer_fQ2;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "PREOBJECT_PRIORITIZER_FQ2: init()");
    }
