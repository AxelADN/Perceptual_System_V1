...
/**
 * PreObjectPrioritizer for route <code>fQ1</code>.
 * 
 * @author axeladn
 * @version 1.0
 */
public class PreObjectPrioritizer_fQ1 extends PreObjectPrioritizerTemplate {
     ...
     */
    public PreObjectPrioritizer_fQ1() {
        this.ID = AreaNames.PreObjectPrioritizer_fQ1;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "PREOBJECT_PRIORITIZER_FQ1: init()");
    }
