...
/**
 * PreObjectPrioritizer for route <code>pQ1</code>.
 * 
 * @author axeladn
 * @version 1.0
 */
public class PreObjectPrioritizer_pQ1 extends PreObjectPrioritizerTemplate {
     ...
     */
    public PreObjectPrioritizer_pQ1() {
        this.ID = AreaNames.PreObjectPrioritizer_pQ1;
    ...
    public void init() {
        super.init();
        SimpleLogger.log(this, "PREOBJECT_PRIORITIZER_PQ1: init()");
    }
