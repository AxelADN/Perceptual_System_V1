...
public class AttentionTrigger extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Mat filter = SpecialKernels.getGauss(V1Bank.simpleCellsBank[0][0].SimpleCellsEven[0].mat.size(), 10, 10, 1);
        proccess.addToV1SimpleCells(filter, 0.8, 0.2, null);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        Mat filter = SpecialKernels.getGauss(V1Bank.simpleCellsBank[0][0].SimpleCellsEven[0].mat.size(), 20, 10, 1);
