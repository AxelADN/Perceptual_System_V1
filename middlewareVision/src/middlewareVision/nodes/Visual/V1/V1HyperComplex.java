    ...
    public void receive(int nodeID, byte[] data) {
        try {
            ...
            if (spike.getModality() == Modalities.VISUAL) {
                ...
                Mat edges = V1Bank.complexCellsBank[0][0][0].ComplexCells[index].mat;
                Mat endStop;
                ...
                V1Bank.hypercomplexCellsBank[0][0][0].HypercomplexCells[0][index].mat = endStop;
                ...
                Visualizer.setImage(Convertor.ConvertMat2Image(V1Bank.hypercomplexCellsBank[0][0][0].HypercomplexCells[0][index].mat), "end stopped " + index, nFrame + index);
