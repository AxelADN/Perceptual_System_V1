    ...
    public void receive(int nodeID, byte[] data) {
        try {
            ...
            if (spike.getModality() == Modalities.VISUAL) {
                ...
                Mat edges = V1Bank.CC.get(0,0,0).Cells[index].mat;
                Mat endStop;
                ...
                V1Bank.HCC.get(0,0,0).Cells[0][index].mat = endStop;
                ...
                Visualizer.setImage(Convertor.Mat2Img(V1Bank.HCC.get(0,0,0).Cells[0][index].mat), "end stopped " + index, nFrame + index);
