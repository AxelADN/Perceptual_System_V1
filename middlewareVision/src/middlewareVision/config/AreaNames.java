...
public class AreaNames {
	...
	public static int V4Contour = IDHelper.generateID("V4", 1, 0);
        ...
        public static int Saliency =        IDHelper.generateID("Saliency", 0, 0);
        public static int SaliencyProccess = IDHelper.generateID("Saliency", 1, 0);
        
        public static int ITC =        IDHelper.generateID("ITC", 0, 0);
        public static int ITCProccess = IDHelper.generateID("ITC", 1, 0);
        
        public static int Babosada1 =        IDHelper.generateID("ITC", 0, 0);
        public static int Babosada1Proccess = IDHelper.generateID("ITC", 1, 0);
        
        public static int Babosada2 =        IDHelper.generateID("ITC", 0, 0);
        public static int Babosada2Proccess = IDHelper.generateID("ITC", 1, 0);
