 ...
 * @author AxelADN
 */
public class pITC_VicinitySizeTransformation extends ProcessTemplate {

    public pITC_VicinitySizeTransformation() {
        this.ID = Names.pITC_VicinitySizeTransformation;
