...
//                System.out.println("LASKALSKALSK");
...
//            }
    ...
    private ArrayList<Mat> featureComparison(ArrayList<Mat> imgs) {
        ...
        time.end();
        long theTime = time.nanoTotal();//time.nanoTotal()*AMY_Images.size()>100000000?100000000:time.nanoTotal()*AMY_Images.size();
        //Reporter.report(thisTime, theTime/1000000, this.systemState);
        sendToAMY();
        return outputImgs;
    }
