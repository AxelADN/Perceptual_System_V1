...
import semanticmemory.areas.ca3.CA3Process2;
 ...
 * @author Luis
 */
public class CA1Process2 extends DSmallNode implements ObjectNodeListener,ContentViewerListener {
    ...
    public CA1Process2(int myName, Node father, NodeConfiguration options, Class<?> areaNamesClass) {
        super(myName, father, options, areaNamesClass);
        
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                viewer = new ContentViewer(CA1Process2.this,"CA1 Content");
    ...
    public void export() {
        ...
        String dotName = "graphCA1_"+ts+".dot";
        String imageName = "memoryCA1_"+ts;
