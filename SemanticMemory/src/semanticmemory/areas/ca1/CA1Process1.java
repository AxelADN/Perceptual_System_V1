 ...
 * @author Luis
 */
public class CA1Process1 extends DSmallNode {

    public CA1Process1(int myName, Node father, NodeConfiguration options, Class<?> areaNamesClass) {
    ...
    private void doProcess(Spike spike) {
        ...
        switch (spike.getType()) {
            ...
            case SpikeNames.VAI_S1:
                ...
                efferents(AreaNames.Subiculum, SpikeUtils.spikeToBytes(spike));
                break;
